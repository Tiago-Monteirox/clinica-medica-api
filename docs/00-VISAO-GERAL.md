...
| Testes | **JUnit 5 + Mockito + MockMvc/WebMvcTest**; Testcontainers preparado | 100 testes cobrindo services, controllers, gateway, publisher, consumer e compatibilidade de schema |
...
| **Prontuário e Histórico Clínico** — prontuário estruturado, histórico longitudinal do paciente e templates clínicos versionados | `atendimento`, `gateway`, `administrativo`, `agendamento` | [`25-PRONTUARIO-HISTORICO.md`](25-PRONTUARIO-HISTORICO.md) |
